...
app.post("/submit", (req, res) => {
  const adjRandom = Math.floor(Math.random() * adj.length);
  const nounRandom = Math.floor(Math.random() * noun.length);
  const bandName = adj[adjRandom] + ' ' + noun[nounRandom];
  console.log(bandName);
  res.render("index.ejs", {theBandName: bandName})
